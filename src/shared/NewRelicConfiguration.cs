...
namespace NewRelic
{
    ...
    public class NewRelicConfiguration
    {
        ...
        public string ApiKeyInsert { get; private set; }
        public string ApiKeyQuery { get; private set; }
        ...
        /// <summary>
        /// The New Relic endpoint where NerdGraph queries can be made.
        /// </summary>
        public string NerdGraphQueryUrl { get; private set; } = "https://api.newrelic.com/graphql";
        ...
        public NewRelicConfiguration(IConfiguration configProvider) : this(configProvider, null)
        { 
        }
        ...
        /// </summary>
        /// <param name="configProvider"></param>
        public NewRelicConfiguration(IConfiguration configProvider, string productSpecificConfig)
        {
            ...
            ApiKeyInsert = GetValue("ApiKeyInsert", productConfigSection, newRelicConfigSection, ApiKeyInsert);
            ApiKeyQuery = GetValue("ApiKeyQuery", productConfigSection, newRelicConfigSection, ApiKeyQuery);
            LicenseKey = GetValue("LicenseKey", productConfigSection, newRelicConfigSection, LicenseKey);
            ...
            NerdGraphQueryUrl = GetValue("NerdGraphUrlOverride", productConfigSection, newRelicConfigSection, NerdGraphQueryUrl);
        ...
        public NewRelicConfiguration WithOverrideEndpointUrl_Trace(string url)
        {
            TraceUrl = url;
            return this;
        }
        ...
        /// <see cref="https://docs.newrelic.com/docs/insights/insights-data-sources/custom-data/introduction-event-api#register">for more information</see>
        public NewRelicConfiguration WithAPIKey(string apiKey)
        {
            ApiKeyInsert = apiKey;
            return this;
        }
        ...
        public NewRelicConfiguration WithAuditLoggingEnabled(bool enabled)
        {
        ...
        public NewRelicConfiguration WithSendTimeoutSeconds(int timeoutSeconds)
        {
        ...
        public NewRelicConfiguration WithMaxRetryAttempts(int retryAttempts)
        {
        ...
        public NewRelicConfiguration WithBackoffMaxSeconds(int backoffMaxSeconds)
        {
        ...
        /// Backoffs would be 5s (5^1), 25s (5^2), 80s (2^3=125 -> 80), 80s (2^4 = 625 -> 80), etc. 
        /// </example>
        public NewRelicConfiguration WithBackoffDelayFactorSeconds(int delayFactorSeconds)
        {
        ...
        public NewRelicConfiguration WithServiceName(string serviceName)
        {
